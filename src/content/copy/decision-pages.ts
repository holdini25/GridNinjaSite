...
export const decisionPages = {
  ...
  dataHandling: {
    ...
    sections: [
      ...
      { title: "Retention and correction", body: "The application includes configurable operational retention procedures, but execution and provider retention must be verified by the operator. No universal deletion deadline is promised here. Use the contact route to request clarification or correction, identifying only the minimum information needed to locate the inquiry.", link: { label: "Contact GridNinja", href: "/contact" } },
    ],
  },
